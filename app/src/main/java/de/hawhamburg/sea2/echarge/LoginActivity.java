...
public class LoginActivity extends ActionBarActivity {
    ...
    private CheckBox mLogin_speichern;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLogin_speichern = (CheckBox)  findViewById(R.id.remember);
        ...
        if(str != null) {
            ...
            mLogin_speichern.setChecked(true);
            ...
            try {
                if (json.getString(KEY_SUCCESS) != null) {
                    ...
                    if(Integer.parseInt(res) == 1){
                        if(mLogin_speichern.isChecked()==true)
                          LoginDatenSchreiben(mEmailView.getText().toString() + ":" +mPasswordView.getText().toString());
                        else
                          LoginDatenLoeschen();
